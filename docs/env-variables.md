...
| `DATABASE_URL` | backend | URL | да | `postgresql://postgres:YdSCArqIBpflQWBNVdCfCrQlYUwOJiQs@shortline.proxy.rlwy.net:13067/railway` | Фиксированная строка подключения к Railway. Изменение запрещено, иначе бэкенд не запустится. |
