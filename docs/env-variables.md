...
| `DATABASE_URL` | backend | URL | да | `postgresql://postgres:BKcXpurIMpiYPkUcxKEHYsZLjoDLYZYP@trolley.proxy.rlwy.net:29631/railway` | Фиксированная строка подключения к Railway. Изменение запрещено, иначе бэкенд не запустится. |
